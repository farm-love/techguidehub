        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="{{ route('admin.posts.create') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-blue-900 dark:text-blue-100">New Post</h4>
                        <p class="text-xs text-blue-700 dark:text-blue-300">Create a new blog post</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.categories.create') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-green-900 dark:text-green-100">New Category</h4>
                        <p class="text-xs text-green-700 dark:text-green-300">Add a new category</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.users.create') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-purple-900 dark:text-purple-100">New User</h4>
                        <p class="text-xs text-purple-700 dark:text-purple-300">Add a new user</p>
                    </div>
                </a>
